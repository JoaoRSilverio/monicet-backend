...
create table monicet_boat (
  ...
  height                        float,
  company_id                    bigint,
  constraint pk_monicet_boat primary key (id)
);
...
create table skippercompany (
  person_id                     bigint not null,
  company_id                    bigint not null,
  constraint pk_skippercompany primary key (person_id,company_id)
);

create table watchmancompany (
  person_id                     bigint not null,
  company_id                    bigint not null,
  constraint pk_watchmancompany primary key (person_id,company_id)
);

create table guidecompany (
  person_id                     bigint not null,
  company_id                    bigint not null,
  constraint pk_guidecompany primary key (person_id,company_id)
);
...
create table roles (
  ...
  name                          varchar(20),
  constraint ck_roles_name check ( name in ('USER','COLLABORATOR','WATCHMAN','SKIPPER','GUIDE','ADMIN','SUPER_ADMIN')),
...
alter table monicet_boat add constraint fk_monicet_boat_company_id foreign key (company_id) references monicet_company (id) on delete restrict on update restrict;
create index ix_monicet_boat_company_id on monicet_boat (company_id);
...
alter table skippercompany add constraint fk_skippercompany_monicet_person foreign key (person_id) references monicet_person (id) on delete restrict on update restrict;
create index ix_skippercompany_monicet_person on skippercompany (person_id);

alter table skippercompany add constraint fk_skippercompany_monicet_company foreign key (company_id) references monicet_company (id) on delete restrict on update restrict;
create index ix_skippercompany_monicet_company on skippercompany (company_id);

alter table watchmancompany add constraint fk_watchmancompany_monicet_person foreign key (person_id) references monicet_person (id) on delete restrict on update restrict;
create index ix_watchmancompany_monicet_person on watchmancompany (person_id);

alter table watchmancompany add constraint fk_watchmancompany_monicet_company foreign key (company_id) references monicet_company (id) on delete restrict on update restrict;
create index ix_watchmancompany_monicet_company on watchmancompany (company_id);

alter table guidecompany add constraint fk_guidecompany_monicet_person foreign key (person_id) references monicet_person (id) on delete restrict on update restrict;
create index ix_guidecompany_monicet_person on guidecompany (person_id);

alter table guidecompany add constraint fk_guidecompany_monicet_company foreign key (company_id) references monicet_company (id) on delete restrict on update restrict;
create index ix_guidecompany_monicet_company on guidecompany (company_id);
